...
const Footer = () => {
  return (
    <footer className="footer-container">
      ...
      <img 
        className="footer-decoration-bottom"
        src="https://api.builder.io/api/v1/image/assets/TEMP/eb815f9cce3a850a3adec1ed6ace2c641fecbb18?width=1442" 
        alt="" 
      />

      {/* License Number */}
      <div className="license-number">
        License Number - 22423537000658
      </div>

      {/* Top decorative image */}
      <img 
        className="footer-decoration-top"
        src="https://api.builder.io/api/v1/image/assets/TEMP/5eec29ce429f648f402b6ca0fb037540299f7c32?width=1670" 
        alt="" 
      />
      ...
      <section className="contact-section">
        ...
        <div className="contact-item phone-item">
          ...
          <span className="contact-text">75501-77722</span>
        </div>
        ...
        <div className="contact-item address-item">
          ...
          <div className="address-text">
            KANDAN KUDIL , 260/2A , GROUND FLOOR , ANBU COLONY 18TH MAIN ROAD BUS STOP NEAR
